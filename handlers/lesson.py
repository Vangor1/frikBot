...
async def start_lesson(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    instruction = (
        ...
        "предоставляешь примеры на русском и английском языках и предлагаешь простые упражнения для закрепления. " #noqa: E501
        "Ты никогда не отклоняешься от заявленной темы и раздела, отвечаешь только по сути и в рамках урока. " #noqa: E501
        "Начинай с приветствия и краткого введения, затем последовательно переходи к лексике, примерам и практике." #noqa: E501
    )
